...
--
-- Table structure for table `MagazineResults`
--

DROP TABLE IF EXISTS `MagazineResults`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `MagazineResults` (
  ...
  `MagazineLink` varchar(1000) NOT NULL,
  ...
  FULLTEXT KEY `idx_MagazineResults` (`Summary`,`Title`,`Categories`)
) ENGINE=InnoDB AUTO_INCREMENT=582900 DEFAULT CHARSET=utf8mb3;
...
-- Dump completed on 2026-02-09 15:03:28
