...
--
-- Table structure for table `NewspaperResults`
--

DROP TABLE IF EXISTS `NewspaperResults`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `NewspaperResults` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Title` varchar(1000) NOT NULL,
  `Link` varchar(1000) NOT NULL,
  `Author` varchar(100) DEFAULT NULL,
  `Summary` varchar(5000) DEFAULT NULL COMMENT 'Newspaper table for articles',
  `Newspaper` varchar(150) NOT NULL,
  `PublishDate` datetime DEFAULT NULL,
  `NewspaperLink` varchar(1000) NOT NULL,
  `ImageTitle` varchar(250) DEFAULT NULL,
  ...
  FULLTEXT KEY `idx_NewspaperResults_Summary` (`Summary`,`Title`,`Categories`)
) ENGINE=InnoDB AUTO_INCREMENT=6184487 DEFAULT CHARSET=utf8mb3;
...
-- Dump completed on 2026-02-09 15:02:31
