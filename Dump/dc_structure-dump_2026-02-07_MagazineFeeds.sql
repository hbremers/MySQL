...
--
-- Table structure for table `MagazineFeeds`
--

DROP TABLE IF EXISTS `MagazineFeeds`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `MagazineFeeds` (
  `URL` varchar(1000) NOT NULL,
  `MagazineName` varchar(150) NOT NULL,
  `MagazineLink` varchar(150) NOT NULL,
  PRIMARY KEY (`URL`),
...
-- Dump completed on 2026-02-09 15:04:26
