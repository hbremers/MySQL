...
--
-- Table structure for table `NewspaperFeeds`
--

DROP TABLE IF EXISTS `NewspaperFeeds`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `NewspaperFeeds` (
  `URL` varchar(1000) NOT NULL,
  `NewspaperName` varchar(150) NOT NULL,
  `NewspaperLink` varchar(150) NOT NULL,
  PRIMARY KEY (`URL`),
...
-- Dump completed on 2026-02-09 15:01:33
