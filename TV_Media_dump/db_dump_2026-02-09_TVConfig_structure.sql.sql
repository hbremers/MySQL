...
--
-- Table structure for table `TVConfig`
--

DROP TABLE IF EXISTS `TVConfig`;
...
CREATE TABLE `TVConfig` (
  ...
  CONSTRAINT `Host_Name_FK` FOREIGN KEY (`HostName`) REFERENCES `Hosts` (`Host_Name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='The current status of all TV backend processes';
...
-- Dump completed on 2026-02-09 14:06:41
